...
// ---    Thu May 25 11:02:58 PKT 2023
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class AdminModulesEOImpl extends EntityImpl {
    /**
    ...
    public static final int MODULECODE = AttributesEnum.ModuleCode.index();
    public static final int MODULENAME = AttributesEnum.ModuleName.index();
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        return EntityDefImpl.findDefObject("S01.model.admin.eo.AdminModulesEO");
    }
    ...
    /**
     * Gets the attribute value for ModuleCode, using the alias name ModuleCode.
     * @return the value of ModuleCode
     */
    public String getModuleCode() {
        return (String) getAttributeInternal(MODULECODE);
    }

    /**
     * Sets <code>value</code> as the attribute value for ModuleCode.
     * @param value value to set the ModuleCode
     */
    public void setModuleCode(String value) {
        setAttributeInternal(MODULECODE, value);
    }
     ...
     * @param value value to set the ModuleName
     */
    ...
    protected void create(AttributeList attributeList) {
        ...
        SequenceImpl seq = new SequenceImpl("ADMIN_MODULES_S", getDBTransaction());
        setModuleId(seq.getSequenceNumber());
